...
public class FournisseurService {
    ...
    public List<Integer> countFournisseursByMobilite() {
        int countMaroc = fournisseurRepo.countByMobilite("Maroc");
        int countEtrangere =fournisseurRepo.countByMobilite("etrangere");
        int countCasapackage = fournisseurRepo.countByMobilite("casa");

        return Arrays.asList(countMaroc, countEtrangere, countCasapackage);
    }
